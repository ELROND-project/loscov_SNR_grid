    ...
    for a1 in range(Nbin):
        ...
        for a2 in range(Nbin):
            ...
            if b1 == b2:
                ...
                Ic1, err1 = monte_carlo_integrate(func_c1, [(0, r2_max), (rs[a1], rs[a1+1]), (0, 2*np.pi), (rs[a2], rs[a2+1]), (0, 2*np.pi)], nsample1)   # 0.01 s

            else:
                Ic1 = 0
                
            Ic2, err2 = monte_carlo_integrate(func_c2, [(0, r2_max), (rs[a1], rs[a1+1]), (0, 2*np.pi), (rs[a2], rs[a2+1]), (0, 2*np.pi)], nsample2) # 0.35 s
